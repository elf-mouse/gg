...
function XLSF(oTarget,urlBase) {
  ...
  function Light(sSizeClass,sClass,nType,x,y) {
    ...
    this.x = x;
    this.y = y;
    this.bg = urlBase+'img/bulbs-'+this.w+'x'+this.h+'-'+this.sClass+'.png';
    this.o.style.width = this.w+'px';
    this.o.style.height = this.h+'px';
    this.o.style.background = 'url('+this.bg+') no-repeat 0 0';
    ...
    this.init = function() {
      ...
      self.flickr();
      xlsf.oFrag.appendChild(self.o);
      self.oExplosion = new Explosion(self.nType,self.sClass,self.x-6,self.y);
    }
...
function smashInit() {
  ...
  var urlBase = '/gg/black-hole/schillmania/';
